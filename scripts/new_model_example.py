...
def validated_train():
    train, test = train_test_generator(dataset, prediction_length=52, n_test_sets=1)
    train, validation = train_test_generator(train, prediction_length=52, n_test_sets=1)
    t = next(validation)
    print(t)
