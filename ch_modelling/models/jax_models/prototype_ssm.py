...
class ObservationDistribution(Protocol[StateType, InputType, ValueType]):
    def __init__(self, state: StateType, global_params: ParameterType, input: dict[str, Any]):
        ...
...
class StateDistribution(Protocol[StateType, ParameterType, InputType]):
    def __init__(self, previous_state: StateType, params: ParameterType, input: InputType):
        ...
...
def state_distribution(previous_state: StateType, params: ParameterType, input: InputType) -> StateDistribution[StateType]:
    ...
